...
# ============================================================
# CHANGE:
# - Derived frontend and backend private IP lists are defined once.
# - App Gateway consumes frontend IPs.
# - Internal Load Balancer consumes backend IPs.
# - Do NOT define these locals again elsewhere in this file.
# ============================================================
...
# ============================================================
# CHANGE:
# - NIC subnet IDs are resolved from module.network.
# - Environment configuration uses vnet_key/subnet_key.
# - No subnet resource IDs are hardcoded here.
# ============================================================
...
# ============================================================
# CHANGE:
# - VM receives the actual NIC ID from module.nic.
# - VM configuration keeps only nic_key.
# ============================================================
...
# ============================================================
# CHANGE:
# - Added reusable Internal Load Balancer module wiring.
# - ILB subnet is resolved from module.network.
# - ILB VNet is resolved from module.network.
# - Backend IPs come from the existing backend_vm_private_ips local.
# - No backend IPs are duplicated in terraform.tfvars.
#
# Traffic:
#
# Frontend VM
...
#     | TCP 8080
#     v
# Internal LB 10.20.2.10:8080
#     |
#     +------> Backend VM 10.20.2.4:8080
#     |
#     +------> Backend VM 10.20.2.5:8080
# ============================================================
...
# ============================================================
# CHANGE:
# - App Gateway subnet ID comes from network module.
# - Public IP comes from public_ip module.
# - Frontend VM IPs come from the existing local.
#
# Traffic:
#
# Internet
...
# ============================================================
# CHANGE:
# - Private DNS VNet association uses network module output.
# - Private endpoint subnet uses network module output.
# - Target resource ID comes from local.private_endpoint_targets.
# ============================================================
...
# ============================================================
# CHANGE:
# - Bastion subnet comes from network module.
# - Bastion public IP comes from public_ip module.
# - Workload VMs remain private.
# ============================================================
